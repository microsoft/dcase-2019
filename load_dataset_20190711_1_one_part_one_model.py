...
class AudioDatasetFine(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print('spectrogram spectrogram spectrogram spectrogram spectrogram')
        # print(type(spectrogram))
        # print(spectrogram.shape)
        spectrogram = torch.from_numpy(spectrogram)
        # l3_emb = torch.from_numpy(l3_emb)

        # print('vgg_emb vgg_emb vgg_emb vgg_emb vgg_emb vgg_emb ')
        # print(type(vgg_emb))
        # print(vgg_emb.shape)
        vgg_emb = torch.from_numpy(vgg_emb.flatten())
        
        # print('label label label label label label label label')
        # print(type(label))
        # print(label)
        label = label.astype(np.float32)
